...
В прошлом посте рассказал о вертикальной черте в IDE и указал на то, что слишком длинная строчка кода может плохо читаться: нужно скроллить горизонтально, вправо/влево. Проблема есть. Не рассказал, как решить эту проблему. Исправляюсь, дополняю прошлый пост и показываю, как решить проблему слишком длинной строки кода.

❌ Писать длинное условие в одну строчку
✅ Разделить длинное условие на несколько строк

Пример на скриншоте. Обратите внимание на серую вертикальную линию справа. Это граница в 80 символов.
...
- Пусть есть задача "проверить каждое число от 1 до 50000 включительно и выяснить, является ли оно простым". 50000 — константа, мы прописываем ее сами в коде `n = 50000`. Чтобы понять 50000 - это 50 тысяч или 500 тысяч, нужно остановиться и внимательно посмотреть на число 50000. Это 50 тысяч. Пришлось остановиться и приглядеться к числу. p.s. простое число — число, у которого есть 2 делителя: 1 и само число. 17 — простое число, его делители: `1, 17. 18` — не простое число, его делители: `1, 2, 9, 18`.
