...
outro для всех постов:

```python
В следующую субботу будет новый пост. Все посты можно найти по хэштегу #пятничныйПитон

Вы можете предложить тему для поста. Пишите ваше предложение и ставьте хэштег #хочутему 😉
