...
Для студентов курса "Вводный курс Python". Курс дает вам фундамент в языке Python. Рубрика **пятничныйПитон** — это дополнение к курсу "Вводный курс Python" проекта 20.35. Рубрику нельзя рассматривать как отдельный и независимый источник знаний. 
